...
int main() {
	...
	cout << "" << endl;
	for (int i = 0; i < 5; ++i) { // No hay una funcion que devuelva el tamaño del arrray
		cout << numeros[i] << ",";
	}
	cout << "" << endl;
	...
	for (int i = 0; i < 5; ++i) { // --> Hay que indicar el tamaño del array
		for (int j = i + 1; j < 5; ++j) {
	...
	cout << "El tamaño de la pila es de: " << pila.size() << " elementos"
			<< endl;
	...
	cout << "El tamaño de la cola es de: " << cola.size() << " elementos"
			<< endl;
