...
public class OPERADORES_Y_ESTRUCTURAS_DE_CONTROL_01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("! operador NOT (invierte el valor de la condición, de true a false y viceversa)");
		...
		System.out.println("Dentro de cada caso se añade 'break;'(opcional), para salir del switch despues de ejecutar el bloque de codigo.");
		System.out.println("Tambien se puede añadir 'default:' para ejecutar el codigo si no se cumple ningun case.");
		...
		System.out.println("Crea un programa que imprima por consola todos los números comprendidos");
		System.out.println("entre 10 y 55 (incluidos), pares, y que no son ni el 16 ni múltiplos de 3.");
