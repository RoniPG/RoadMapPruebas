...
public class ESTRUCTURAS_DE_DATOS_03 {
	...
	public static void main(String[] args) {
		...
		nombres.add("Hola"); // Se añade a la primera posicion disponible
		nombres.add("Mundo"); // Se añade al final de la lista
		nombres.add("Nuevo");
		...
		nombres.remove(2); // Eliminamos le dato que esta en la posición 2
		// System.out.println("Este el el dato en la posición 2 : "+nombres.get(2)); -->
		...
		noRepsHS.add(1);
		noRepsTS.add(1);
		noRepsLHS.add(1); // ---> Añadimos datos repetidos
