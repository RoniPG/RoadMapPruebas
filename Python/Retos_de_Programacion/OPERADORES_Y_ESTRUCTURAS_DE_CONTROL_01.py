...
print("operador not (invierte el valor de la condición, de true a false y viceversa)")
...
print("entre 10 y 55 (incluidos), pares, y que no son ni el 16 ni múltiplos de 3.")
