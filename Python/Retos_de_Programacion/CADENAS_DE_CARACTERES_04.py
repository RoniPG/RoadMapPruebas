...
Isogramas
"""
def Palíndromo(a:str):
    """
    Palindromo:
    Palabra o frase cuyas letras estÃ¡n dispuestas de tal manera que resulta la misma leÃ­da de izquierda a derecha que de derecha a izquierda.
    Por ejemplo: anilina
    """
    a1=a.lower()
    aux=""
...
def Isograma(a:str):
    ...
    Si cada letra aparece solo una vez serÃ¡ un heterograma, si aparece dos, un isogroma de segundo orden y asÃ­ sucesivamente.
    Por ejemplo:
    Heterogramas: yuxtaponer, centrifugado, luteranismo.
    Isogramas con una repeticiÃ³n o de segundo orden: acondicionar, escritura, intestinos.
    """
    flag=False
    count=0
    a1=set()
